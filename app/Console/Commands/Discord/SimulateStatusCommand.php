...
class SimulateStatusCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'discord:simulate-status {--url= : URL del webhook de Discord}';
     ...
     * @var string
     */
    protected $description = 'Simula el comando /status de Discord';
    ...
    public function handle()
    {
        ...
        $this->info("Enviando comando /status a {$url}...");
